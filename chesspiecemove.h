...
public:
    ...
    virtual bool apply(ChessPiece (&field)[ROWS][COLS], const ChessBoard& board,
                       bool* ft_move1 = NULL, bool* ft_move2 = NULL)      {  UNUSED(field,board); UNUSED(ft_move1, ft_move2); return false;  }
    //@param board is needed to check whether king is under attack
    virtual bool undo(ChessPiece (&field)[ROWS][COLS],
                      bool* ft_move1 = NULL, bool* ft_move2 = NULL)       {  UNUSED(field); UNUSED(ft_move1, ft_move2); return false;  }
    ...
    std::shared_ptr<ChessPieceMove> from_string(const std::string& str)   {  UNUSED(str);   return std::shared_ptr<ChessPieceMove>(NULL); }
...
public:
    ...
    virtual bool apply(ChessPiece (&field)[ROWS][COLS], const ChessBoard& board, bool* ft_move1 = NULL, bool* ft_move2 = NULL);
    virtual bool undo(ChessPiece (&field)[ROWS][COLS], const ChessBoard& board, bool* ft_move1 = NULL, bool* ft_move2 = NULL);
